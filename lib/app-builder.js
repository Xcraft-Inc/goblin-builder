  ...
  *_electron() {
    ...
    switch (process.platform) {
      case 'win32': {
        ...
        if (this._app.build.win32.targets) {
          buildTargets.push(...this._app.build.win32.targets);
        } else {
          buildTargets.push('zip');
        }
        break;
      }
      case 'linux': {
        targets = Platform.LINUX.createTarget(null, getArch());
        if (this._app.build.linux.targets) {
          buildTargets.push(...this._app.build.linux.targets);
        } else {
          buildTargets.push('AppImage');
        }
        break;
      }
      case 'darwin': {
        ...
        if (this._app.build.darwin.targets) {
          buildTargets.push(...this._app.build.darwin.targets);
        } else {
          buildTargets.push('zip');
        }
        break;
